...
(13, 'A hardware shortage', 'Incorrect: The crisis was related to software development issues', FALSE, 4),
...
(17, 'Waterfall model', 'Correct: Waterfall was the first formal software development model', TRUE, 5),
...
(21, 'Lack of programming languages', 'Incorrect: Programming languages existed but were difficult to manage', FALSE, 6),
...
(25, 'Predict outcomes', 'Correct: The goal is to learn a mapping from inputs to outputs for prediction.', TRUE, 7),
...
(28, 'Optimize cluster groups', 'Incorrect: This is not applicable to supervised learning.', FALSE, 7),
...
(32, 'Time-series data', 'Incorrect: Unsupervised learning does not specifically focus on time-series.', FALSE, 8),
...
INSERT INTO Score (User_ID, Activity_ID, Question_ID, Course_ID, TStamp, Score) VALUES
('ErPe1024', 1, 'Q1', 'NCSUOganCSC440F24', '2024.08.01-11:10', 3),
('ErPe1024', 2, 'Q2', 'NCSUOganCSC440F24', '2024.08.01-14:18', 1),
('AlAr1024', 1, 'Q1', 'NCSUOganCSC440F24', '2024.08.01-13:24', 3),
...
('LeMe1024', 7, 'Q1', 'NCSUJegiCSC522F24', '2024.09.01-13:12', 3),
('LeMe1024', 8, 'Q2', 'NCSUJegiCSC522F24', '2024.09.09-18:27', 3);
